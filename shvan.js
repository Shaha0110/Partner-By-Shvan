...
client.on("ready", () => {
  var join = client.channels.get("1154841303524319242"); /// ئاید ڤۆیس
  if (join) join.join();
});
...
https://discord.gg/BmUw8vzcB6`); /// لینکە سیرڤەرە خۆت

      client.channels.get("1159870748689707069").send(////ئایدی ژوری تێکست
...
client.login("MTE2MDg3NzgwMDk5NjIxMjc3OQ.GBYIdw.4Q945zOowqUlR3S2FJftSsLk1tKfPzFYV3vkyQ");
////////////////
